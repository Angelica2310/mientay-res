          ...
          <div className="relative grid min-w-0 items-center gap-10 md:grid-cols-12">
            ...
            <div className="min-w-0 md:col-span-7">
              ...
              <p
                ...
                style={{ color: "rgba(43,43,43,0.78)" }}
              >
                Our family-run kitchen draws from home-style recipes passed down
                and refined over time. From broths simmered for hours to crisp
                bánh xèo and vibrant herbs, every dish is prepared with care and
